...
"""
    MoinMoin Macro
    UserLogin - Macro-ized from UserPreferences
    Depends on presence of userlogin Action.
...
class UserLoginForm:
    ...
    def make_form(self):
        ...
        self._form.append(html.INPUT(type="hidden", name="action", value="userlogin"))
...
def execute(macro, arguments):
    ...
    answer = UserLoginForm(macro.request).asHTML()
    return answer