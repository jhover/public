...
(set-c-offsets "unclassified Acanthamoeba"  '(0 -7)  '(0 0))
(set-c-offsets "unclassified Bicosoecida"  '(0 1)  '(0 0))

(set-c-offsets "Basidiomycota"  '(0 2)  '(0 -7))
(set-c-offsets "Agaricomycotina"  '(0 0)  '(0 -5))
(set-c-offsets "Tremellomycetes"  '(0 -4)  '(0 -3))
